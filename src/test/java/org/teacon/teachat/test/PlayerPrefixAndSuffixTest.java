...
public class PlayerPrefixAndSuffixTest {
    ...
    public void testParseMultiColoredText() {
        ...
        Assertions.assertInstanceOf(PlainTextContents.LiteralContents.class, node2.getContents());
        Assertions.assertEquals("please ignore", ((PlainTextContents.LiteralContents)node2.getContents()).text());
    ...
    public void testRainbow() {
        ...
        var node2 = siblings.get(1);
        Assertions.assertInstanceOf(PlainTextContents.LiteralContents.class, node2.getContents());
        Assertions.assertEquals("a", ((PlainTextContents.LiteralContents)node2.getContents()).text());
        Assertions.assertEquals(TextColor.fromLegacyFormat(ChatFormatting.GOLD), node2.getStyle().getColor());
        var node3 = siblings.get(2);
        Assertions.assertInstanceOf(PlainTextContents.LiteralContents.class, node3.getContents());
        Assertions.assertEquals("i", ((PlainTextContents.LiteralContents)node3.getContents()).text());
        Assertions.assertEquals(TextColor.fromLegacyFormat(ChatFormatting.YELLOW), node3.getStyle().getColor());
        var node4 = siblings.get(3);
        Assertions.assertInstanceOf(PlainTextContents.LiteralContents.class, node4.getContents());
        Assertions.assertEquals("n", ((PlainTextContents.LiteralContents)node4.getContents()).text());
        ...
        Assertions.assertInstanceOf(PlainTextContents.LiteralContents.class, node5.getContents());
        Assertions.assertEquals("b", ((PlainTextContents.LiteralContents)node5.getContents()).text());
        Assertions.assertEquals(TextColor.fromLegacyFormat(ChatFormatting.AQUA), node5.getStyle().getColor());
        var node6 = siblings.get(5);
        Assertions.assertInstanceOf(PlainTextContents.LiteralContents.class, node6.getContents());
        Assertions.assertEquals("o", ((PlainTextContents.LiteralContents)node6.getContents()).text());
        ...
        Assertions.assertInstanceOf(PlainTextContents.LiteralContents.class, node7.getContents());
        Assertions.assertEquals("w", ((PlainTextContents.LiteralContents)node7.getContents()).text());
    ...
    public void testResetting() {
        ...
        var node2 = siblings.get(1);
        Assertions.assertInstanceOf(PlainTextContents.LiteralContents.class, node2.getContents());
        Assertions.assertEquals("text ", ((PlainTextContents.LiteralContents)node2.getContents()).text());
        Assertions.assertEquals(TextColor.fromLegacyFormat(ChatFormatting.GOLD), node2.getStyle().getColor());
        var node3 = siblings.get(2);
        Assertions.assertInstanceOf(PlainTextContents.LiteralContents.class, node3.getContents());
        Assertions.assertEquals("please ignore", ((PlainTextContents.LiteralContents)node3.getContents()).text());
